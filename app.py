...
with st.sidebar:
    ...
    if (
        ...
        st.caption(
            ...
            🎯 Try predicting the final
            clusters before reaching
            iteration 20!
            """
        )
...
with info_col:
    ...
    if iteration == 0:
        ...
        st.markdown(
            ...
            The coloured regions show which
            centroid is closest.
        ...
        st.markdown(
            ...
            Points are assigned to their
            nearest centroid.

            <br><br>

            The centroids then move toward
            the centre of their groups.

            <br><br>

            Watch the <b>✕ markers</b>
            and coloured regions move!
...
with step1:
    ...
    st.markdown(
        ...
        K-means first places a number of
        <b>centroids</b> on the canvas.

        <br><br>

        You can let the computer choose them
        randomly or place them yourself.
...
with step2:
    ...
    st.markdown(
        ...
        <b>"Which centroid am I closest to?"</b>
...
with step3:
    ...
    st.markdown(
        ...
        The coloured regions change as the
        centroids move.
